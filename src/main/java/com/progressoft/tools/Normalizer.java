...
public interface Normalizer {
     ...
     * @return
     */
    ScoringSummary zscore(Path csvPath, Path destPath, String colToStandardize) throws FileNotFoundException;
     ...
     * @return
     */
    ScoringSummary minMaxScaling(Path csvPath, Path destPath, String colToNormalize) throws FileNotFoundException;
}
